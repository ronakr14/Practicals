...
def main():
    ...
    df = pd.read_csv(args.csv_file, encoding='utf-8')  # Ensure CSV file is read with UTF-8 encoding
    ...
    if conn is not None:
        ...
        # Check if table creation was successful before proceeding with bulk insert
...
# python .\Q5_multilang.py --config-file config.ini --csv-file D:\Assignments\Python\Python_Assignment3_Akshaykumar\multilang_data.csv --create-table word111